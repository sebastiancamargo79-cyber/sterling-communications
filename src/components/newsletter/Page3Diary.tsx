...
const FALLBACK_SLOTS: EventItem[] = [
  { type: 'photo', image_url: '', caption: 'Our team at a recent community event.' },
  { type: 'photo', image_url: '', caption: 'Clients enjoying a group activity session.' },
  { type: 'photo', image_url: '', caption: 'Spring flowers brightening up our office reception.' },
  { type: 'photo', image_url: '', caption: 'Award-winning care — our team at a recognition ceremony.' },
  { type: 'photo', image_url: '', caption: 'Volunteers and staff joining forces for a charity fundraiser.' },
  { type: 'photo', image_url: '', caption: 'New recruits completing their first training day.' },
]
  ...
  if (item.type === 'photo') {
    return (
      <div className={styles.card}>
        <ImgOrPlaceholder className={styles.cardPhoto} src={item.image_url} alt={item.caption} />
